    ...
    public sealed class ModSearch : IEquatable<ModSearch>
    {
        ...
        public static ModSearch FromAuthors(ModuleLabelList     allLabels,
            ...
            => new ModSearch(
                ...
                "", authors.Select(a => ReleaseDto.nonAlphaNums.Replace(a, "")).ToList(), "",
                null, null,
                                       ...
                                       string          combined)
        {
            ...
            foreach (string s in pieces)
            {
                ...
                {
                    byDescription += (ShouldNegateTerm(desc, out string subDesc) ? "-" : "") + ReleaseDto.nonAlphaNums.Replace(subDesc, "");
                }
                ...
                else
                {
                    ...
                    byName += (ShouldNegateTerm(s, out string subS) ? "-" : "") + ReleaseDto.nonAlphaNums.Replace(subS, "");
                }
            }
